...
<!--                    </ul>
        ...
        <!-- /.navbar-static-side -->
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Promotion Profile</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <!--<form role="form" action="health_promotion_profile.php" method="GET">-->
                                        <fieldset disabled>
                                    <div class="col-lg-6">
...
//                                                                    echo "<option value = "  . ">" . $subdistricts["subdistrict_id"] . "</option> ";
                                        ...
                                        <button type="button" class="btn btn-default" onclick="location.href='health_promotion_view.php?idhealth_promotion=<?php print  $_REQUEST['idhealth_promotion'] ?>';">Delete</button>
                                        <button type="button" class="btn btn-default" onclick="location.href='health_promotion_view.php';">Back</button>
